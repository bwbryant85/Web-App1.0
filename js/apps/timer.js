...
function initTimer() {
  ...
  wrap.style.cssText = 'width:100%;height:100%;display:flex;flex-direction:column;align-items:center;background:#050508;overflow:hidden;padding-top:0;padding-bottom:8px;';
