/* ════════════════════════════════════════════════════════════
   MAPS v2 — Modern (Windows 11 / Apple Maps style)
   Leaflet + CartoDB Positron  |  Nominatim geocoding
   Glass search bar • Floating pill controls • Live suggestions
   ════════════════════════════════════════════════════════════ */
...
function initMaps98() {
  ...
  clearBtn.innerHTML = '✕';
  clearBtn.style.cssText = 'border:none;background:rgba(0,0,0,0.09);color:#48484a;width:20px;height:20px;border-radius:50%;cursor:pointer;font-size:11px;display:none;align-items:center;justify-content:center;flex-shrink:0;padding:0;transition:all 0.15s ease;';
  ...
  bottomPill.style.cssText = 'position:absolute;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000;display:flex;align-items:center;gap:0;background:rgba(255,255,255,0.92);backdrop-filter:blur(20px) saturate(180%);-webkit-backdrop-filter:blur(20px) saturate(180%);border-radius:22px;box-shadow:0 4px 20px rgba(0,0,0,0.14),0 1px 4px rgba(0,0,0,0.08);overflow:hidden;';
  ...
  compass.style.cssText = 'position:absolute;top:84px;right:16px;z-index:1000;width:40px;height:40px;border-radius:50%;background:rgba(255,255,255,0.92);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border:none;box-shadow:0 2px 12px rgba(0,0,0,0.14);font-size:18px;cursor:pointer;color:#1c1c1e;display:flex;align-items:center;justify-content:center;transition:transform 0.2s ease;';
  ...
  function loadLeaflet(cb) {
    ...
    script.onerror = () => {
      loadScreen.innerHTML = '<div style="font-size:40px;">⚠️</div><div style="font-size:16px;font-weight:600;color:#1c1c1e;">Connection Error</div><div style="font-size:13px;color:#8e8e93;text-align:center;max-width:220px;">Unable to load Maps. Check your internet connection.</div>';
    };
  ...
  function initLeafletMap() {
    ...
    /* CartoDB Positron — minimal, clean, Apple Maps-like white style */
  ...
  compass.addEventListener('click', () => {
    mapInstance && mapInstance.setBearing && mapInstance.setBearing(0);
